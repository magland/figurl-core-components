...
const TabWidget = ({ children, tabs, width, height }) => {
    ...
    return (_jsx("div", Object.assign({ style: { position: 'absolute', left: hMargin, top: vMargin, width: W, height: H, overflow: 'hidden' }, className: "TabWidget" }, { children: _jsxs("div", Object.assign({ style: { position: 'absolute', left: 0, top: 0, width: W, height: tabBarHeight } }, { children: [_jsx(TabWidgetTabBar, { tabs: tabs, currentTabIndex: currentTabIndex, onCurrentTabIndexChanged: setCurrentTabIndex, onTabClosed: () => { } }), children2.map((c, i) => {
