...
export declare const isVec3: (x: any) => x is Vec3;
...
export declare const pointIsInEllipse: (pt: Vec2 | Vec2H, center: Vec2 | Vec2H, xRadius: number, yRadius?: number) => boolean;
...
export declare const getRectFromPointPair: (pointA: Vec2, pointB: Vec2) => Vec4;
...
export declare const getBasePixelTransformationMatrix: (pixelSpaceWidth: number, pixelSpaceHeight: number, newTargetSystem?: RectangularRegion) => {
...
export declare const transformPoints: (tmatrix: TransformationMatrix, points: Vec2[]) => Vec2[];
